...
frappe.ui.form.on('Stock Entry', {
    on_submit: function (frm) {
        if (frm.doc.stock_entry_type === 'Manufacture') {
//        if (frm.doc.stock_entry_type === 'Manufacture' && frm.doc.update_valuation_rate_a_010 === 1) {
            frappe.call({
                method: "omsteel_test_001.omsteel_test_001.production_items_table.update_qty_stock_entry_detail_from_transfer_qty",
                args: {
                    docname: frm.doc.name
...
frappe.ui.form.on('Stock Entry', {
    refresh: function(frm) {
        if ((frm.doc.docstatus === 0) && frm.doc.stock_entry_type === 'Manufacture') {
            frm.add_custom_button(__('Update Qty [(Finished Item) & UOM= "ربطة"]]'), function () {
                frappe.confirm(
...
//            }).addClass('btn-warning').css({
            }, __("Update Qty")).addClass('btn-warning').css({
...
//    refresh: function(frm) {
//        if ((frm.doc.docstatus === 0) && frm.doc.stock_entry_type === 'Manufacture') {
//            frm.add_custom_button(__('Updates Valuation Rate'), function () {
//                        frappe.call({
//                            method: "omsteel_test_001.omsteel_test_001.production_items_table.get_stock_and_rate_standard_valuation_rate",
//                            args: {
//                                doc_name: frm.doc.name
...
//                                if (!r.exc) {
//                            frappe.show_alert({
//                                            message: __('Updates Valuation Rate successfully'),
//                                            indicator: 'green'
//                                        });
//                                    frm.reload_doc();
//                                }
...
//                    if (!r.exc) {
//                        frappe.show_alert({
//                            message: __('Updated Valuation Rate Successfully'),
//                            indicator: 'green'
//                        });
//                        frm.reload_doc();
//                    }
...
////   ================================================================
////   ================================================================
////   ============= START START Fetch Qty (Finished Item) & UOM (حبة) tie_the_bundle_a_010 ==================
//
//
//
//frappe.ui.form.on('Stock Entry', {
//    refresh: function(frm) {
//        if ((frm.doc.docstatus === 0) && frm.doc.stock_entry_type === 'Manufacture') {
//            frm.add_custom_button(__('Update Qty [(Finished Item) & UOM] "حبة"'), function () {
//                frappe.confirm(
//                    'Are you sure you want to update the quantities of finished items?',
//                    function() {
//                        frappe.call({
//                            method: "omsteel_test_001.omsteel_test_001.production_items_table.update_finished_item_qty_uom_piece",
//                            args: {
//                                doc: frm.doc.name
//                            },
//                            callback: function(r) {
...
//                );
////            }).addClass('btn-warning').css({
//            }, __("Update Qty [(Finished Item) & UOM 'حبة'")).addClass('btn-warning').css({
//
//                    'color': 'white',
//                    'font-weight': 'bold',
//                    'background-color': '#563627',
...
//
//
////   ===========  END START Fetch Qty (Finished Item) & UOM (حبة) tie_the_bundle_a_010 ========
////   ================================================================
////   ================================================================
...
//   ================================================================
//   ================================================================
//   ============= START Fetch Qty (Finished Item) & UOM (حبة) & (Scrap Item) (Production Items Table) & UOM (حبة) tie_the_bundle_a_010 ==================
...
frappe.ui.form.on('Stock Entry', {
    refresh: function(frm) {
        if ((frm.doc.docstatus === 0) && frm.doc.stock_entry_type === 'Manufacture') {
            ...
            }, __('Update Qty [(UOM "حبة"')).addClass('btn-warning').css({
                'color': 'white',
                'font-weight': 'bold',
                'background-color': '#563627',
                'margin-top': '15px',
            ...
            frm.add_custom_button(__('Update Qty [(Production Items Table & UOM] "حبة"'), function () {
                frappe.confirm(
                    'Are you sure you want to update the quantities of Production Items Table?',
                    function() {
                        frappe.call({
                            method: "omsteel_test_001.omsteel_test_001.production_items_table.update_production_items_qty_uom_piece",
                            args: {
                                doc: frm.doc.name
                            },
                            callback: function(r) {
...
//                                    frm.add_custom_button(__('Update Qty [(Production Items Table & UOM] "حبة"').prop('disabled', true);

//                                    frm.page.get_inner_button(__('Update Qty [(Production Items Table & UOM] "حبة"')).hide();
//                                    frm.page.get_inner_button(__('Update Qty [(UOM "حبة"')).hide();
            ...
            }, __('Update Qty [(UOM "حبة"')).addClass('btn-info').css({
                'color': 'white',
                'font-weight': 'bold',
...
//   ===========  END Fetch Qty (Finished Item) & UOM (حبة) & (Scrap Item) (Production Items Table) & UOM (حبة) tie_the_bundle_a_010 ========
//   ================================================================
//   ================================================================
...
//   ================================================================
//   =====================   UOM (متر)   ============================
//   ============= START Fetch Qty (Finished Item) & UOM (متر) & (Scrap Item) (Production Items Table) & UOM (متر) tie_the_bundle_a_010 ==================
...
frappe.ui.form.on('Stock Entry', {
    refresh: function(frm) {
        if ((frm.doc.docstatus === 0) && frm.doc.stock_entry_type === 'Manufacture') {
            frm.add_custom_button(__('Update Qty [(Finished Item) & UOM] "متر"'), function () {
                frappe.confirm(
                    'Are you sure you want to update the quantities of Finished items?',
                    function() {
                        frappe.call({
                            method: "omsteel_test_001.omsteel_test_001.production_items_table.update_finished_item_qty_uom_piece_meter",
                            args: {
                                doc: frm.doc.name
                            },
                            callback: function(r) {
            ...
            }, __('Update Qty [(UOM "متر"')).addClass('btn-warning').css({
                'color': 'white',
                'font-weight': 'bold',
                'background-color': '#563627',
                'margin-top': '15px',
            ...
            frm.add_custom_button(__('Update Qty [(Production Items Table & UOM] "متر"'), function () {
                frappe.confirm(
                    'Are you sure you want to update the quantities of Production Items Table?',
                    function() {
                        frappe.call({
                            method: "omsteel_test_001.omsteel_test_001.production_items_table.update_production_items_qty_uom_piece_meter",
                            args: {
                                doc: frm.doc.name
                            },
                            callback: function(r) {
...
//                                    frm.add_custom_button(__('Update Qty [(Production Items Table & UOM] "متر"').prop('disabled', true);

//                                    frm.page.get_inner_button(__('Update Qty [(Production Items Table & UOM] "متر"')).hide();
//                                    frm.page.get_inner_button(__('Update Qty [(UOM "متر"')).hide();
            ...
            }, __('Update Qty [(UOM "متر"')).addClass('btn-info').css({
                'color': 'white',
                'font-weight': 'bold',
                'background-color': '#004085',
                'margin-top': '15px',
...
//   ===========  END Fetch Qty (Finished Item) & UOM (متر) & (Scrap Item) (Production Items Table) & UOM (متر) tie_the_bundle_a_010 ========
//   ================================================================
//   ================================================================
...
frappe.ui.form.on('Stock Entry', {
    after_save: function (frm) {
    if (frm.doc.docstatus === 0 && frm.doc.update_create_batch_bundles === 0 && frm.doc.stock_entry_type === 'Material Transfer for Manufacture') {
        frappe.call({
...
//   ================================================================
//   ================================================================
//   ==== START Stock Entry Refresh After Submit====
...
//   ==== END Stock Entry Refresh After Submit ====
//   ================================================================
//   ================================================================
...
//   ================================================================
//   ================================================================
//   ==== START Set the scrap_material_cost and base_scrap_material_cost to 0 ====


////frm.set_value('scrap_material_cost', 0);
//
//
//frappe.ui.form.on('BOM', {
//    validate: function(frm) {
...
//
//            frappe.call({
//                method: "omsteel_test_001.omsteel_test_001.production_items_table.update_bom_cost",
//                args: {
//                    doc: frm.doc.name
//                },
//                callback: function(r) {
//                    if (!r.exc) {
//                frappe.show_alert({
//                        message: __('Update BOM Cost successfully'),
//                        indicator: 'green'
//                    });
//                frm.reload_doc();
//                }
...
//   ==== END Set the scrap_material_cost and base_scrap_material_cost to 0  ====
//   ================================================================
//   ================================================================
...
//                    method: "omsteel_test_001.omsteel_test_001.production_items_table.update_stock_entry_valuation_rate",
//                    args: {
//                        docname: frm.doc.name,
...
//                frappe.show_alert({
//                    message: __('Updated Cost for all items'),
//                    indicator: 'green'
//                });
//                frm.reload_doc();
//            }).catch(error => {
//                frappe.show_alert({
//                    message: __('An error occurred: {0}').format(error.message),
//                    indicator: 'red'
//                });
//            });
//        }
...
frappe.ui.form.on("Stock Entry", {
    refresh: function(frm) {
        if (frm.doc.docstatus === 0 && frm.doc.stock_entry_type === 'Material Transfer for Manufacture') {
            ...
            frm.doc.items.forEach(item => {
                let button = frm.add_custom_button(__('Update Valuation Rate'), function() {
                    let promise = frappe.call({
                        method: "omsteel_test_001.omsteel_test_001.production_items_table.update_valuation_rate_in_material_transfer_for_manufacture",
                        args: {
                            "doc": frm.doc.name,
                            "item_code": item.item_code,
                        },
                ...
                button.addClass('btn-warning').css({
                    'color': 'white',
                    'font-weight': 'bold',
                    'background-color': '#274472'
                });
            ...
            if (promises.length > 0) {
                Promise.all(promises).then(results => {
                    frappe.show_alert({
                        message: __('Update Valuation Rate for all Items'),
                        indicator: 'green'
                    });
                    frm.reload_doc();
                }).catch(error => {
...
//
//            frm.doc.items.forEach(item => {
//                let button = frm.add_custom_button(__('After Submit Valuation Rate'), function() {
//                    let promise = frappe.call({
//                        method: "omsteel_test_001.omsteel_test_001.production_items_table.update_valuation_rate_in_material_transfer_for_manufacture",
//                        args: {
//                            "doc": frm.doc.name,
...
//        }
//
//        frappe.msgprint("Custom override for get_items_for_mr is triggered");
//
...
//
//        frappe.call({
//            method: "omsteel_test_001.overrides.production_plan.CustomProductionPlan.get_items_for_material_requests",
//            args: {
//                warehouses: [{ warehouse: frm.doc.for_warehouse }]
//            },
//            callback: function(response) {
//                if (response.message) {
//                    frappe.msgprint(__("Response from Python: " + response.message));
//                }
//            }
//        });
//
...
frappe.ui.form.on('Production Plan', {
    get_items_for_mr_a_010: function(frm) {
        frappe.call({
            method: "omsteel_test_001.omsteel_test_001.production_items_table.get_items_for_material_requests_a",
            args: {
                "doc": frm.doc.name,
                "warehouses": frm.doc.for_warehouse ? [frm.doc.for_warehouse] : []
            },
//            freeze: true,
            callback: function(response) {
                if (response.message) {
...
////   ================================================================
////   ================================================================
////   ==== START Loop through all items in the Stock Entry Detail child table and make 'qty' editable ====
//
//
//
//
...
//            frm.fields_dict['items'].grid.get_field('qty').df.read_only = 0;
...
//
//
////   ==== END Loop through all items in the Stock Entry Detail child table and make 'qty' editable ====
////   ================================================================
////   ================================================================
...
//   ================================================================
//   ================================================================
//   ==== START Check if the value is "Material Transfer" and toggles the qty field in the items table to be editable ====



frappe.ui.form.on('Stock Entry', {
    onload: function (frm) {
        toggle_qty_editable(frm);
    },
    refresh: function (frm) {
        toggle_qty_editable(frm);
    },
...
//function toggle_qty_editable(frm) {
//    if (frm.fields_dict.items && frm.fields_dict.items.grid) {
//        const editable = frm.doc.stock_entry_type === "Material Transfer";
//
//        frm.fields_dict.items.grid.grid_rows.forEach(function (row) {
//            row.toggle_editable('qty', editable);
//        });
//    }
//}
...
function toggle_qty_editable(frm) {
    if (frm.fields_dict.items && frm.fields_dict.items.grid) {
        ...
        frm.fields_dict.items.grid.update_docfield_property('qty', 'read_only', !editable);
...
//        if (frm.doc.stock_entry_type === "Material Transfer") {
//
//            frm.fields_dict.items.grid.wrapper.find('.grid-row').each(function(index, row) {
//                frm.fields_dict.items.grid.grid_rows[index].toggle_editable('qty', true);
//            });
//        } else {
//
//            frm.fields_dict.items.grid.wrapper.find('.grid-row').each(function(index, row) {
//                frm.fields_dict.items.grid.grid_rows[index].toggle_editable('qty', false);
//            });
//        }
//    }
//});
...
//   ==== END Check if the value is "Material Transfer" and toggles the qty field in the items table to be editable ====
//   ================================================================
//   ================================================================
...
//   ================================================================
//   ================================================================
//   ==== START Hide elements Progress Bar ====



frappe.ui.form.on('Work Order', {
    onload(frm) {
        const elements = document.querySelectorAll('.row.form-dashboard-section.progress-area');
...
//   ==== END Hide elements Progress Bar ====
//   ================================================================
//   ================================================================
...
//   ================================================================
//   ================================================================
//   ==== START  Fetch data from items table - A - Select Batch Method Update (3) Material Transfer ====
...
//    if (frm.doc.docstatus === 0 && frm.doc.stock_entry_type === 'Material Transfer for Manufacture' || frm.doc.stock_entry_type === 'Material Transfer') {
    if (frm.doc.docstatus === 0 && frm.doc.stock_entry_type === 'Material Transfer') {
        frm.add_custom_button(__('Select Batch Method (3)'), function() {
            open_item_dialog_aa_test(frm);
        }).addClass('btn-warning').css({
                'color': 'white',
                'font-weight': 'bold',
                'background-color': '#274472',
...
function open_item_dialog_aa_test(frm) {
    let d = new frappe.ui.Dialog({
        title: 'Select Item and Scan Batch Numbers',
        fields: [
            {
        ...
        primary_action(values) {
            ...
            fetch_quantity_aa_test(frm, values.item_code, values.warehouse, values.batch_no);
//            fetch_batch_data(values.item_code, values.warehouse, values.batch_no).then(() => {
//                frappe.msgprint(__('Batch data fetched successfully'));
//            }).catch(err => {
//                frappe.msgprint(__('Error fetching batch data: ') + err.message);
//            });
    ...
    d.fields_dict.item_code.$input.on('change', function() {
        ...
        // Fetch batch numbers based on the selected item code and warehouse
        fetch_batch_numbers_aa_test(selected_item_code).then(batches => {
            // Format batch options to include batch_id and batch_qty
            let batch_options = batches.map(batch => `${batch.batch_id} (Qty: ${batch.batch_qty})`).join('\n');
...
function fetch_batch_numbers_aa_test(item_code) {
    return new Promise((resolve, reject) => {
        frappe.call({
            method: 'omsteel_test_001.omsteel_test_001.production_items_table.fetch_batch_numbers',
            args: {
...
function fetch_batch_data_aa_test(item_code, warehouse, batch_id) {
    frappe.call({
        method: 'omsteel_test_001.omsteel_test_001.production_items_table.get_batch_data',
        args: {
            item_code: item_code,
...
function fetch_quantity_aa_test(frm, item_code, warehouse, batch_no) {
    // Find the item in the items table
    let item = frm.doc.items.find(i => i.item_code === item_code);

    if (item) {
        // Fetch batch and serial number details
        select_batch_and_serial_no_aa_test(frm, item, warehouse, batch_no).then(() => {
//            frappe.msgprint(__('Batch and serial number details fetched successfully'));
        }).catch(err => {
            frappe.msgprint(__('Error fetching batch and serial number details: ') + err.message);
        });
...
function select_batch_and_serial_no_aa_test(frm, item, warehouse, batch_no) {
    return new Promise((resolve, reject) => {
        frappe.db.get_value("Item", item.item_code, ["has_batch_no", "has_serial_no"]).then((r) => {
            if (r.message && (r.message.has_batch_no || r.message.has_serial_no)) {
                item.has_serial_no = r.message.has_serial_no;
                ...
                new erpnext.BatchPackageSelectorAA_test(frm, item, (r) => {
                    if (r) {
                        frappe.model.set_value(item.doctype, item.name, {
                            serial_and_batch_bundle: r.name,
                            use_serial_batch_fields: 0,
...
erpnext.BatchPackageSelectorAA_test = class BatchPackageSelector {
    constructor(frm, item, callback) {
        this.frm = frm;
        this.item = item;
        this.qty = item.qty;
...
//   ==== END Fetch data from items table - A - Select Batch Method Update (3) Material Transfer ====
// ===============================================================
// ===============================================================
...
frappe.listview_settings['Stock Entry'] = {
    onload: function(listview) {
        ...
        const icon = `
//            <span style="" >
            <span style="cursor: pointer;" title="Search by Batch No.">
                <i class="fa fa-cogs" style="color: rgb(39, 68, 114); font-size: 25px;" aria-hidden="true"></i>
            </span>
        `;


//        listview.page.add_action_icon('fa fa-cog', function() {
//        listview.page.add_action_icon('reload', function() {
        listview.page.add_action_icon(icon, function() {
            frappe.prompt([
                {
                    fieldname: 'batch_no',
                    label: 'Batch No',
            ...
            function(data) {
                frappe.call({
                    method: 'omsteel_test_001.omsteel_test_001.production_items_table.get_voucher_no_by_batch',
                    args: {
                    ...
                    callback: function(r) {
                        if (r.message && r.message.length > 0) {
                            listview.filter_area.add([
                                ['Stock Entry', 'name', 'in', r.message]
                            ]);
                            listview.refresh();
                        } else {
                            frappe.msgprint(__('No Stock Entries found for this Batch No.'));
                        }
                    }
                });
            },
