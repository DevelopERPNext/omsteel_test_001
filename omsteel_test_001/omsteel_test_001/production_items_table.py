...
#         "Stock Entry Detail",
#         filters={"parent": doc.name},
#         fields=["name", "item_code", "qty", "uom", "is_finished_item", "basic_rate", "bom_no", "item_name",
#                 "standard_deviation_a_020", "t_warehouse"]
#     )
#
#     try:
...
#
#                 whole_qty = int(total_qty)
#                 decimal_qty = total_qty - whole_qty
#
#                 frappe.db.set_value("Stock Entry Detail", item["name"], "qty", 1)
#
#                 for i in range(1, whole_qty):
#                     query = """
#                             INSERT INTO `tabStock Entry Detail`
#                             (idx, parent, item_code, name, qty, basic_rate, uom, stock_uom, parenttype, parentfield, is_finished_item, bom_no, conversion_factor, item_name, standard_deviation_a_020, t_warehouse)
#                             SELECT
#                                 IFNULL(MAX(idx), 0) + 1 AS new_idx,
#                                 %(parent)s,
#                                 %(item_code)s,
